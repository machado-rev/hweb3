...
class Hweb3 {
   ...
   * @param {string} urlString URL of the blockchain API. eg. http://althash:password@127.0.0.1:14889
  ...
  /** ******** RAW TRANSACTIONS ********* */
  /**
   * Get the hex address of a Html address.
  ...
  /**
   * Converts a hex address to html address.
   * @param {string} hexAddress Html address in hex format.
   * @return {Promise} Html address or Error.
   */
  ...
  /** ******** UTIL ********* */
  /**
   * Validates if a valid Html address.
   * @param {string} address Html address to validate.
   ...
   * @param {string} address The html address for the private key.
  ...
  /**
   * Encrypts the wallet for the first time. This will shut down the html server.
  ...
  /**
   * Gets the account name associated with the Html address.
   * @param {string} address The html address for account lookup.
  ...
  /**
   * Gets the Html address based on the account name.
  ...
  /**
   * Gets the Html address with the account name.
   * @param {string} acctName The account name ("" for default).
   * @return {Promise} Html address array or Error.
   */
  ...
  /**
   * Gets a new Html address for receiving payments.
   ...
   * @return {Promise} Array of addresses with HTML balances or Error.
   */
  ...
  /**
   * Lists unspent transaction outputs.
   * @param {string} address Address to send HTML to.
   * @param {number} amount Amount of HTML to send.
   ...
   * @param {string} senderAddress The HTML address that will be used to send money from.
   ...
   * @param {bumber} amount The transaction fee in HTML/kB.
